...
# batchnorm je extension tadytoho -- ale bude mít o tejden pozdějc dedlajn
...
class Network:
    ...
    def construct(self, args):
        with self.session.graph.as_default():
            ...
            # or even better:
            # add explicit dependencies for the training, so that whenever
            # training is run the update operations are also run
